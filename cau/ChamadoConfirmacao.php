...
/*
if($chamado->QTD_MIN_SLA_TRIAGEM != ""){
	$vTempoRestante = $pagina->FormatarData($myDate->diff($chamado->DTH_INICIO_PREVISAO, 'all'));
	$pagina->LinhaColspan("center", "<font size=3>O tempo estimado para o início do atendimento é de <b>$vTempoRestante</b></font>.", "2", "");
	$pagina->LinhaColspan("center", "<br>", "2", "");
}
*/
/*
if($chamado->QTD_MIN_SLA_ATENDIMENTO != ""){
...
*/
//$pagina->LinhaColspan("center", "Estes valores foram estimados com base na categoria de atendimento selecionada para o chamado. Caso a categoria tenha sido equivocadamente selecionada, a área de TI efetuará a correção que poderá implicar em alterações nos tempos acima informados.", "2", "");
$pagina->LinhaColspan("center", "<br><a href=\"ChamadoDetalhesCEA.php?v_SEQ_CHAMADO=$v_SEQ_CHAMADO\">Clique aqui para acompanhar o andamento do chamado. </a>", "2", "");
