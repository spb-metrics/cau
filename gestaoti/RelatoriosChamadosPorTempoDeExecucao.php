...
$pagina->SettituloCabecalho("Tempo de atendimento por chamado	"); // Indica o título do cabeçalho da página
...
<script language="javascript">
	...
	function fValidaFormLocal(){
		...
		document.form.action = 'RelatoriosChamadosPorTempoDeExecucao.php';
	...
	function fValidaFormLocal1(){
		if(fValidaFormLocal()){
			document.form.action = 'RelatoriosChamadosPorTempoDeExecucaoPDF.php';
...
//		$pagina->CampoSelect("v_COD_DEPENDENCIA", "N", "Dependencia", $v_OPCAO_TODOS_DEPENDENCIA, $aItemOptionDependencia, "Escolha", "do_CarregarComboEquipe()")."&nbsp;".
		...
		$pagina->CampoSelect("v_NUM_MATRICULA_RECURSO", "N", "Profissional", $vItemTodosProfissional, $aItemOptionProfissional, "Escolha", "", "combo_profissional"), "left", "id=".
		$pagina->GetIdTable());

$pagina->LinhaCampoFormulario("Período:", "right", "S", "de ".
		$pagina->CampoData("v_DTH_INICIO", "N", " de Abertura", $v_DTH_INICIO)." a ".
		$pagina->CampoData("v_DTH_INICIO_FINAL", "N", " de Encerramento efetivo", $v_DTH_INICIO_FINAL), "left", "id=".$pagina->GetIdTable());
