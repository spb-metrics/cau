...
$pagina->SettituloCabecalho("Chamados Atendidos"); // Indica o título do cabeçalho da página
...
<script language="javascript">
	...
	function fValidaFormLocal(){
		...
		document.form.action = 'RelatoriosChamadosAtendidos.php';
	...
	function fValidaFormLocal1(){
		if(fValidaFormLocal()){
			document.form.action = 'RelatoriosChamadosAtendidosPDF.php';
