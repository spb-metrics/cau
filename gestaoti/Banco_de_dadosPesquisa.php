...
$pagina->SettituloCabecalho("Pesquisa de Tipos de Banco de Dados"); // Indica o título do cabeçalho da página
// Itens das abas
...
if($banco->database->rows == 0){
	...
	$pagina->LinhaHeaderTabelaResultado("Bancos de dados encontrados para os parâmentos pesquisados", $header);
