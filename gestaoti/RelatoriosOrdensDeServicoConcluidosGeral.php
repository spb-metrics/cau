...
$pagina->SettituloCabecalho("Geral"); // Indica o título do cabeçalho da página
...
<script language="javascript">
	...
	//	}
		...
		document.form.action = 'RelatoriosOrdensDeServicoConcluidosGeral.php';
	...
	function fValidaFormLocal1(){
		if(fValidaFormLocal()){
			document.form.action = 'RelatoriosOrdensDeServicoConcluidosGeralPDF.php';
