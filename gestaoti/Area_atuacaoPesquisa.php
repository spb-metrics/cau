...
*/
// =======================================================================
// Página de pesquisa de exclusão de registros da tabela Area_atuacao
// =======================================================================
...
$pagina->SettituloCabecalho("Pesquisa Área de Atuação"); // Indica o título do cabeçalho da página
// Itens das abas
...
if($banco->database->rows == 0){
	...
	$pagina->LinhaHeaderTabelaResultado("Áreas de Atuação", $header);
