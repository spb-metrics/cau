...
<script language="javascript">
	...
	function do_CarregarComboEdificacao() {
		...
		x_CarregarComboEdificacao("", retorno_CarregarComboEdificacao);
	}
	// Retorno
	...
	function fValidaFormLocal(){
		...
		if(document.form.v_DTH_ABERTURA_FINAL.value == ""){
			alert("Preencha o campo Data de Final");
		...
		document.form.action = 'Relatorios_chamadoPesquisa.php';
	...
	function fValidaFormLocal1(){
		if(fValidaFormLocal()){
			document.form.action = 'Relatorios_chamadoPesquisaPDF.php';
...
$pagina->LinhaCampoFormulario("<a href=\"javascript: fExibirParametros();\"><img border=\"0\" src=\"imagens/menos.jpg\"></a>", "right", "N", "<a href=\"javascript: fExibirParametros();\">Ocultar Filtros de Pesquisa</a>", "left","","3%");
$pagina->FechaTabelaPadrao();
...
$pagina->LinhaCampoFormulario("Data de Abertura:", "right", "S", "de ".$pagina->CampoData("v_DTH_ABERTURA", "N", " de Abertura", $v_DTH_ABERTURA)
." a ".$pagina->CampoData("v_DTH_ABERTURA_FINAL", "N", " de Abertura", $v_DTH_ABERTURA_FINAL), "left");

$pagina->LinhaCampoFormularioColspan("center", $pagina->CampoButton("return fValidaFormLocal1();", " Rel. PDF "), "2");
$pagina->FechaTabelaPadrao();
