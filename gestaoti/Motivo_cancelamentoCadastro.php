...
if($flag == ""){
	...
	$pagina->SettituloCabecalho("Cadastro de Motivo de Cancelamento de Chamado"); // Indica o título do cabeçalho da página
	// Itens das abas
	...
	$pagina->LinhaCampoFormulario("Descrição:", "right", "S", $pagina->CampoTexto("v_DSC_MOTIVO_CANCELAMENTO", "S", "Descrição", "60", "60", ""), "left");
