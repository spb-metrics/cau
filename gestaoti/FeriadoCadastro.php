...
if($flag == ""){
	...
	$pagina->SettituloCabecalho("Cadastro data de feriado"); // Indica o título do cabeçalho da página
	// Itens das abas
	...
	$pagina->LinhaCampoFormulario("Nome:", "right", "S", $pagina->CampoTexto("v_NOM_FERIADO", "S", "Nome", "60", "60", ""), "left");
        $pagina->LinhaCampoFormulario("Data:", "right", "S", $pagina->CampoData("v_DTH_FERIADO", "S", "Nome", ""), "left");
