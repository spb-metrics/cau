...
$pagina->SettituloCabecalho("Ordens de Serviço Abertas"); // Indica o título do cabeçalho da página
...
<script language="javascript">
	...
	function fValidaFormLocal(){
		...
		document.form.action = 'RelatoriosOrdensDeServicoAbertas.php';
	...
	function fValidaFormLocal1(){
		if(fValidaFormLocal()){
			document.form.action = 'RelatoriosOrdensDeServicoAbertasPDF.php';
