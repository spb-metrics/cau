...
$pagina->SettituloCabecalho("Tempo médio de atendimento no 1º nível"); // Indica o título do cabeçalho da página
...
<script language="javascript">
	function fValidaFormLocal(){
		...
		document.form.action = 'RelatoriosKPITempoMedioAtendimentoPDF.php';
