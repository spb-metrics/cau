...
$pagina->SettituloCabecalho("Atendimento de Chamados - Meus Chamados"); // Indica o título do cabeçalho da página
...
// =======================================================================================================================
$v_EXIBIR = "NAO EXIBIR CHAMADOS DA MINHA EQUIPE";
...
//	if($_SESSION["FLG_LIDER_EQUIPE"] == "S"){
		...
		if($banco->database->rows > 0){
			...
			$pagina->LinhaColspan("center", "Chamados aguardando aprovação", "2", "header");
