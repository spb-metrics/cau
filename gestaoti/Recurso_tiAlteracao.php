...
if($flag == ""){
	...
	$pagina->SettituloCabecalho("Alterar Colaborador"); // Indica o título do cabeçalho da página
	// Itens das abas
	...
	$pagina->LinhaCampoFormulario("Dependência:", "right", "N", $banco->DEP_SIGLA, "left");
	$pagina->LinhaCampoFormulario("Lotação:", "right", "N", $banco->UOR_SIGLA, "left");
	...
	$pagina->LinhaCampoFormulario("Cargo/Função:", "right", "S", $pagina->CampoSelect("v_SEQ_PERFIL_RECURSO_TI", "S", "Perfil recurso ti", "S", $aItemOption), "left");
