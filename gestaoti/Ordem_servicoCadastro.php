...
if($flag == ""){
	...
	$pagina->SettituloCabecalho("Cadastro de Ordem de Serviço"); // Indica o título do cabeçalho da página
	...
	$pagina->LinhaCampoFormulario("Nº da O.S.:", "right", "S", $pagina->CampoTexto("v_NUM_ORDEM_SERVICO", "S", "Número", "30", "30", ""), "left"); 
	$pagina->LinhaCampoFormulario("Valor:", "right", "N", $pagina->CampoTexto("v_VAL_PAGAMENTO", "N", "Valor de Pagamento", "8", "8", ""), "left"); 
	$pagina->LinhaCampoFormulario("Nº da Nota fiscal:", "right", "N", $pagina->CampoTexto("v_NUM_NOTA_FISCAL", "N", "Número de Nota fiscal", "30", "30", ""), "left"); 
	...
	$pagina->LinhaCampoFormulario("Número da Pec:", "right", "N", $pagina->CampoTexto("v_NUM_PEC", "N", "Número de Pec", "30", "30", ""), "left"); 
	...
	$banco->insert();
	// Código inserido: $banco->SEQ_ORDEM_SERVICO_TI
	if($banco->error != ""){
