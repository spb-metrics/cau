...
$pagina->SettituloCabecalho("Chamados Por Colaborador"); // Indica o título do cabeçalho da página
...
<script language="javascript">
	...
	//	}
		...
		document.form.action = 'RelatoriosChamadosPorColaborador.php';
	...
	function fValidaFormLocal1(){
		if(fValidaFormLocal()){
			document.form.action = 'RelatoriosChamadosPorColaboradorPDF.php';
