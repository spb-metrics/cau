...
$pagina->SettituloCabecalho("Taxa de Resolução Imediata de Chamados"); // Indica o título do cabeçalho da página
...
<script language="javascript">
	function fValidaFormLocal(){
		...
		document.form.action = 'RelatoriosKPITaxaResolucaoPDF.php';
