...
$pagina->SettituloCabecalho("Tempo de atendimento por atribuição"); // Indica o título do cabeçalho da página
...
<script language="javascript">
	...
	//	}
		...
		document.form.action = 'RelatoriosChamadosPorTempoDeAtribuicao.php';
	...
	function fValidaFormLocal1(){
		if(fValidaFormLocal()){
			document.form.action = 'RelatoriosChamadosPorTempoDeAtribuicaoPDF.php';
