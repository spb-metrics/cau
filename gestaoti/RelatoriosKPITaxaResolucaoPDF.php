...
$kpi->fileName = "imagens/RelTaxaResolucao.png";
$kpi->KpiChamadosPorSLANivel1();

$kpi->GraficoOdometro($kpi->valorOdometro);

$pdf->Image('imagens/RelTaxaResolucao.png', 15, 50, 120, 70, "PNG"); // importa uma imagem

// Buscar dados consolidados
$vMETA = $parametro->GetValorParametro("MetaTaxaResolucaoImediata");
...
$pdf->Cell(50, 9, number_format($valorMeta - ($kpi->cont - $kpi->contForaPrazo), 2), 1, 0, "R", 1);
