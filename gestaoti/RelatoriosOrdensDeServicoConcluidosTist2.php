...
$pagina->SettituloCabecalho("TIST-2"); // Indica o título do cabeçalho da página
...
<script language="javascript">
	...
	function fValidaFormLocal(){			
		...
		document.form.action = 'RelatoriosOrdensDeServicoConcluidosTist2.php';
	...
	function fValidaFormLocal1(){
		if(fValidaFormLocal()){
			document.form.action = 'RelatoriosOrdensDeServicoConcluidosTist2PDF.php';
...
$pagina->LinhaCampoFormulario("Período:", "right", "S",
			"de " .$pagina->CampoData("v_DTH_ATRIBUICAO", "N", " de Abertura", $v_DTH_ATRIBUICAO)
			." a ".$pagina->CampoData("v_DTH_ENCERRAMENTO_EFETIVO", "N", " de Encerramento efetivo", $v_DTH_ENCERRAMENTO_EFETIVO)
