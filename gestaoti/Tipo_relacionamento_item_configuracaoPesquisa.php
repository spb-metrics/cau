...
$pagina->SettituloCabecalho("Pesquisa Relacionamento entre Itens do Parque Tec."); // Indica o título do cabeçalho da página
// Itens das abas
...
if($banco->database->rows == 0){
	...
	$pagina->LinhaHeaderTabelaResultado("Relacionamentos entre Itens do Parque Tecnológico", $header);
