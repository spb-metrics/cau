...
$pagina->SettituloCabecalho("Pesquisa Sistema Operacional"); // Indica o título do cabeçalho da página
// Itens das abas
...
if($banco->database->rows == 0){
	...
	$pagina->LinhaHeaderTabelaResultado("Sistema operacionals encontrados para os parâmentos pesquisados", $header);
