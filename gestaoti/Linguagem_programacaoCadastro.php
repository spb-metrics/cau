...
if($flag == ""){
	...
	$pagina->SettituloCabecalho("Cadastro de Linguagem de Programação"); // Indica o título do cabeçalho da página
	// Itens das abas
	...
	$pagina->LinhaCampoFormulario("Nome:", "right", "S", $pagina->CampoTexto("v_NOM_LINGUAGEM_PROGRAMACAO", "S", "Nome", "60", "60", ""), "left"); 
	...
	$banco->insert();
	// Código inserido: $banco->SEQ_LINGUAGEM_PROGRAMACAO
	if($banco->error != ""){
		$pagina->mensagem("Registro não incluído. O seguinte erro ocorreu:<br> $banco->error");
	}else{
		$pagina->redirectTo("Linguagem_programacaoPesquisa.php?v_SEQ_LINGUAGEM_PROGRAMACAO=$banco->SEQ_LINGUAGEM_PROGRAMACAO");
	}
}
?>
