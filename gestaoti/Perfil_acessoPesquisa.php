...
$pagina->SettituloCabecalho("Pesquisa  Perfil de Acesso"); // Indica o título do cabeçalho da página
// Itens das abas
...
if($banco->database->rows == 0){
	...
	$pagina->LinhaHeaderTabelaResultado("Perfil acessos encontrados para os parâmentos pesquisados", $header);
