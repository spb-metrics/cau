	 ...
	 for ($i = 0; $i < count($_SESSION['ATIVIDADES_RDM']); $i++){
			...
			if(($_SESSION['ATIVIDADES_RDM'][$i][5]==null || $_SESSION['ATIVIDADES_RDM'][$i][5]=="")||
				($_SESSION['ATIVIDADES_RDM'][$i][6]==null || $_SESSION['ATIVIDADES_RDM'][$i][6]=="")){
					$vRegrasVioladas = true;
					$vMsgErro = "Informe a Data/Hora de execução para todas as atividades da RDM!";
			} 				 
	}
...
$pagina->SettituloCabecalho("Abrir Requisição de mudança - RDM"); // Indica o título do cabeçalho da página
$pagina->method = "post";
...
// Informações Gerais
// ============================================================================================================
$pagina->LinhaCampoFormularioColspanDestaque("Informações Gerais &nbsp;".$pagina->ButtonSelecionarTemplateDeRDM("fSelTemplateRDM"), 2);
