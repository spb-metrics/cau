...
if($flag == ""){
	...
	$pagina->SettituloCabecalho("Cadastro de Frequência de Manutenção"); // Indica o título do cabeçalho da página
	// Itens das abas
	...
	$pagina->LinhaCampoFormulario("Nome:", "right", "S", $pagina->CampoTexto("v_NOM_FREQUENCIA_MANUTENCAO", "S", "Nome", "60", "60", ""), "left"); 
	...
	$banco->insert();
	// Código inserido: $banco->SEQ_FREQUENCIA_MANUTENCAO
	if($banco->error != ""){
		$pagina->mensagem("Registro não incluído. O seguinte erro ocorreu:<br> $banco->error");
	}else{
		$pagina->redirectTo("Frequencia_manutencaoPesquisa.php?v_SEQ_FREQUENCIA_MANUTENCAO=$banco->SEQ_FREQUENCIA_MANUTENCAO");
	}
}
?>
