...
$pdf->subtitulo = "Resolução do incidente no tempo estipulado (2º nível)";
...
$kpi->fileName = "imagens/RelResolucaoIncidente.png";
$kpi->KpiPorcentagemChamadosEncerradosNoPrazoIncidente();

$kpi->GraficoOdometro($kpi->valorOdometro);

$pdf->Image('imagens/RelResolucaoIncidente.png', 15, 50, 120, 70, "PNG"); // importa uma imagem

// Buscar dados consolidados
$vMETA = $parametro->GetValorParametro("MetaTaxaResolucaoIncidente");
