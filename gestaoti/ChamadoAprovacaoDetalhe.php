...
if($v_SEQ_CHAMADO != ""){
	...
	//if($atividade_chamado->NUM_MATRICULA_APROVADOR == $_SESSION["NUM_MATRICULA_RECURSO"] ||
	//   $atividade_chamado->NUM_MATRICULA_APROVADOR_SUBSTITUTO == $_SESSION["NUM_MATRICULA_RECURSO"]){			
