...
$pagina->SettituloCabecalho("Pesquisa de Edificações"); // Indica o título do cabeçalho da página
// Itens das abas
...
//	$pagina->LinhaVazia(1);
	...
	if($banco->database->rows == 0){
		...
		$pagina->LinhaHeaderTabelaResultado("Edificações encontradas para os parâmentos pesquisados", $header);
		while ($row = pg_fetch_array($banco->database->result)){
			...
			$valor .= $pagina->BotaoLupa("Localizacao_fisicaPesquisa.php?flag=1&v_SEQ_EDIFICACAO=".$row["seq_edificacao"], "Ver locais físicos");
