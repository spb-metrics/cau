...
$pagina->SettituloCabecalho("Pesquisa Prioridade"); // Indica o título do cabeçalho da página
// Itens das abas
...
if($banco->database->rows == 0){
	...
	$pagina->LinhaHeaderTabelaResultado("Tipo criticidades encontrados para os parâmentos pesquisados", $header);
