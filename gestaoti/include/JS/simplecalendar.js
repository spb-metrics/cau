	...
	***********************************************************************************
	Modifications made by:
		Kevin Southworth <southwo8@msu.edu>
		http://kevin.tridubdesign.com/
	Date: 4/6/2004
	DHTML Calendar
	Version 1.3
	
	Amendments:
		6 Apr 2004 - 	Added the "callback" function feature, which calls a
						user-specified function when clicking on a day in the calendar,
						in addition to the normal functionality of filling a text field.
						This script will call the callback function with the following
						arguments:
							callbackFunction( year, month, day )
						NOTE: arguments are passed as numbers, not strings
	************************************************************************************
	*/
	...
	*/
	...
	if (browser.dom || browser.ie4){
		...
		document.writeln('clip:rect(0px 147px ' + height + 'px 0px);');
	...
	function Calendar(){
	  ...
	  this.months = new Array("Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Decembro");
...
//   	   eval( this.callback + "( " + this.year + ", " + padZero(this.month+1) + ", " + padZero(day) + " )" );
	   // fill the target text field with the formatted date string
	...
	Calendar.prototype.show = function(event, target, callback, bHasDropDown, dateFormat, dateFrom, dateTo){
