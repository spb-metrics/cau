	...
	function sajax_get_common_js() {
		...
		function sajax_debug(text) {
 		...
 		function sajax_init_object() {
 			sajax_debug("sajax_init_object() chamado..")
			...
			if (!A)
				sajax_debug("Nao foi possivel criar o objeto de coneccao.");
			return A;
		}
		...
		function sajax_do_call(func_name, args) {
			...
			sajax_debug("no sajax_do_call().." + sajax_request_type + "/" + sajax_target_id);
			...
			if (sajax_request_type == "GET") {
				...
				alert("Tipo de requisição illegal: " + sajax_request_type);
			}
			...
			if (x == null) {
				if (sajax_failure_redirect != "") {
					...
					sajax_debug("Objeto SAJAX nulo para o agente usuário:\n" + navigator.userAgent);
					return false;
				}
			} else {
					...
					if (status == "") {
						...
						if (target_id != "")
							...
							try {
								...
								sajax_debug("Erro pego " + e + ": Não foi possível declarar " + data );
							}
						}
					}
				}
