...
// **********************
class atividade_rb_rdm_template{
	// class : begin
	
	// ***********************
	// DECLARAÇÃO DE ATRIBUTOS
	// ***********************
	var $SEQ_ATIVIDADE_RB_RDM_TEMPLATE;   // KEY ATTR. WITH AUTOINCREMENT
	...
	// CONSTRUCTOR METHOD
	// **********************
	function atividade_rb_rdm_template(){ 
	...
	function select($id){
		$sql = "SELECT SEQ_ATIVIDADE_RB_RDM_TEMPLATE , SEQ_RDM_TEMPLATE , SEQ_ITEM_CONFIGURACAO , SEQ_SERVIDOR , ORDEM , DESCRICAO
			    , SEQ_EQUIPE_TI FROM gestaoti.atividade_rb_rdm_template
				WHERE SEQ_ATIVIDADE_RB_RDM_TEMPLATE = $id";
		$result = $this->database->query($sql);
		$result = $this->database->result;
		$row = pg_fetch_object($result, 0);
		$this->SEQ_ATIVIDADE_RB_RDM_TEMPLATE = $row->seq_atividade_rb_rdm_template;
	...
	function selectParam($orderBy = 1, $vNumPagina = "", $vQtdRegistros = "20"){
		...
		$sqlSelect = "SELECT SEQ_ATIVIDADE_RB_RDM_TEMPLATE , SEQ_RDM_TEMPLATE , SEQ_ITEM_CONFIGURACAO , SEQ_SERVIDOR ,
							 ORDEM, DESCRICAO,SEQ_EQUIPE_TI ";
		$sqlCorpo  = "FROM gestaoti.atividade_rb_rdm_template 
					  WHERE 1 = 1 ";

		if($this->SEQ_ATIVIDADE_RB_RDM_TEMPLATE != ""){
			$sqlCorpo .= "  and SEQ_ATIVIDADE_RB_RDM_TEMPLATE = $this->SEQ_ATIVIDADE_RB_RDM_TEMPLATE";
		}
	...
	// **********************
	function delete($id){
		$sql = "DELETE FROM gestaoti.atividade_rb_rdm_template WHERE SEQ_ATIVIDADE_RB_RDM_TEMPLATE = $id";
		$result = $this->database->query($sql);
	}
	function deleteByRDM($id){
		$sql = "DELETE FROM gestaoti.atividade_rb_rdm_template WHERE SEQ_RDM_TEMPLATE = $id";
		$result = $this->database->query($sql);
	}
	...
	function insert(){
		$this->SEQ_ATIVIDADE_RB_RDM_TEMPLATE = $this->database->GetSequenceValue("gestaoti.SEQ_ATIVIDADE_RB_RDM_TEMPLATE");
		
		$sql = "INSERT INTO gestaoti.atividade_rb_rdm_template(SEQ_ATIVIDADE_RB_RDM_TEMPLATE,
										  SEQ_RDM_TEMPLATE,
							 ...
							 VALUES (".$this->iif($this->SEQ_ATIVIDADE_RB_RDM_TEMPLATE=="", "NULL", "'".$this->SEQ_ATIVIDADE_RB_RDM_TEMPLATE."'").",
	...
	// ********************** 
	function update($id){
		$sql = " UPDATE gestaoti.atividade_rb_rdm_template
