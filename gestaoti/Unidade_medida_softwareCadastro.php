...
if($flag == ""){
	...
	$pagina->SettituloCabecalho("Cadastro de Unidade de Medida de Software"); // Indica o título do cabeçalho da página
	// Itens das abas
	...
	$pagina->LinhaCampoFormulario("Nome:", "right", "S", $pagina->CampoTexto("v_NOM_UNIDADE_MEDIDA_SOFTWARE", "S", "Nome", "60", "60", ""), "left"); 
	...
	$banco->insert();
	// Código inserido: $banco->SEQ_UNIDADE_MEDIDA_SOFTWARE
	if($banco->error != ""){
		$pagina->mensagem("Registro não incluído. O seguinte erro ocorreu:<br> $banco->error");
	}else{
		$pagina->redirectTo("Unidade_medida_softwarePesquisa.php?v_SEQ_UNIDADE_MEDIDA_SOFTWARE=$banco->SEQ_UNIDADE_MEDIDA_SOFTWARE");
	}
}
?>
